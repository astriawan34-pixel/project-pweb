...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Jul 03, 2026 at 05:28 AM
...
CREATE TABLE `booking` (
  ...
  `status_booking` enum('Menunggu','Dikonfirmasi','Selesai','Dibatalkan') NOT NULL DEFAULT 'Menunggu',
...
CREATE TABLE `lapangan` (
  ...
  `status` enum('Tersedia','Dibooking','Maintenance') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Lapangan 1', 'Sintetis', 120000.00, 'Dibooking');
